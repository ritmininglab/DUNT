...
def prototypical_loss(prototypes, embeddings, targets, 
    ...
    if distance == 'euclidean':
        ...
        loss_n = nn.functional.nll_loss(-squared_distances, targets, reduction="none",**kwargs).cpu().detach().numpy()
        #nn.functional.mse_loss
        #loss_n = nn.functional.mse_loss(-squared_distances, targets, reduction="none", **kwargs).cpu().detach().numpy()
        ...
        loss_n = nn.functional.nll_loss(cosine_similarities, targets, reduction="none", **kwargs).cpu().detach().numpy()
        #loss_n = nn.functional.mse_loss(cosine_similarities, targets, reduction="none", **kwargs).cpu().detach().numpy()
    ...
    return loss, accuracy.item(),loss_n,logits
